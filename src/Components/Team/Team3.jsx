                        ...
                        <div className="team-title-wrap mb-60 md-mb-40">
                            <div className="title-area mb-0">
                                <div className="sub-title">
                                    <span><i className="asterisk"></i></span>MEET THE TEAM
                                </div>
                                <h2 className="sec-title mb-0">
                                    Introducing our dedicated <br /> expert <span className="bold">insurance experts</span>
                                </h2>
                            </div>
                            <div className="member-stats-box d-flex align-items-center">
                                ...
                                <p className="text">PROFESSIONAL <br /> TEAM MEMBERS</p>
                            </div>
                        </div>
                    </div>
                </div>
