          ...
          <div className="cs_main_header_in">
            ...
            <div className="cs_main_header_right">
              ...
              <div className="header-right">
                  <a href="tel:+181234567" className="header-btn"><span className="fa-solid fa-headphones"></span>406-351-2222</a>
      ...
      <div id="sidebar-area" className={`sidebar header-sidebar-area ${sideNav ? 'active' : ''}`}>
            ...
            <div className="sidebar-content">
                <div className="sidebar-logo">
                    <a className="dark-logo" href="/"><img src="/assets/images/logo/sharkey_logo.png" alt="logo" /></a>
                </div>
